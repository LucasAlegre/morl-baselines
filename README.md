...
| [Iterated Pareto Referent Optimisation-2D (IPRO-2D)](https://github.com/LucasAlegre/morl-baselines/blob/main/morl_baselines/multi_policy/ipro/ipro_2d.py) <sup>[2](#f1)</sup> | Multi               | SER                         | Continuous            | Discrete              | [Paper](https://arxiv.org/abs/2402.07182)                                                                                                                |
...
<b id="f2">1</b>: PCN assumes environments with deterministic transitions. <br>
